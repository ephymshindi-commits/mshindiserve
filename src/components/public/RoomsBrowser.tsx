...
export function RoomsBrowser({ rooms }: { rooms: Room[] }) {
  ...
  async function submitBooking() {
    ...
    try {
      ...
      await paymentsApi.stkPush({ phoneNumber: normalizedPhone, bookingId: booking.id });
      setConfirmedBooking(booking.bookingNumber);
  ...
  return (
    <>
      ...
      <Dialog.Root open={Boolean(selectedRoom && isAuthenticated)} onOpenChange={(open) => !open && closeBooking()}>
        <Dialog.Portal>
